...
Como existe a possibilidade de um indivíduo não estar cadastrado no sistema ou acabar sendo confundido com outro indivíduo, o administrador do sistema pode analisar a presença que foi atribuida no momento que um indivíduo foi ou não reconhecido, para que se necessário, retirar ou modifiar a presença manualmente.  
