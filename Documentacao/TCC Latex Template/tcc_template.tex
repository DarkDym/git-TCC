...
O processo de funcionamento do presente trabalho segue a ordem indicada na figura \ref{diag}
...
\section{Processamento Digital de Sinais}\label{r3}



\subsection{Sistemas lineares e invariantes no tempo}
bla bla bla

\subsubsection{Impulso Unitário}
\begin{figure}[htb]
\centering
\includegraphics[width=0.6\textwidth]{Figuras/1.png}
\caption{Função impulso.}
\label{dirac}
\end{figure}
...
\section{Transformada \textit{Wavelet}} \label{r4}
bla bla bla

\subsection{Modelo do neurônio biológico} \label{MNB}
...
\section{Arduino Due}\label{mm1}

\chapter{Resultados e discussões}

\section{Geração da RNA} \label{RD1}
